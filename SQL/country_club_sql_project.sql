...
/*The Facilities that charge members are:
Tennis Court 1
Tennis Court 2
Massage Room 1
Massage Room 2
...
/* 4 facilities do not charge members a fee */
...
ELSE 'cheap' END AS price_status
FROM `Facilities`
...
SELECT DISTINCT fac.name, CONCAT( mem.firstname, ' ', mem.surname ) AS fullname
FROM `Bookings` book
...
/*1054 - Unknown column 'book.slots' in 'field list'*/
